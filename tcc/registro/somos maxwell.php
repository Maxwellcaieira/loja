...
<section class="corpo">
    <div class="conteudo">
                <div class="ima">
    <h2>Maxwell de Souza Caieira</h2> <img src="./img/max.jpg">
                </div>
            <div class="texto">
    <p>Com 20 anos de idade, nasceu no dia 14/03/2001 na Cidade do Rio de Janeiro, Filho de Luzia de Souza Caieira e Marcelo Oliveira Caieira residentes em Duque de Caxias - Baixada Fluminense. Iniciol sua jornada no Colégio Pedro II - Caxias no ano de 2017 e depois de tantas dificuldades está encerrando mais um ciclo em sua vida, o fim de seu Ensino Medío - Técnico em Desenvolvimento de Sistemas.</p>
            </div>
    </div>
</section>
</BODY>
