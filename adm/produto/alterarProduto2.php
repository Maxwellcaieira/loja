...
include "conexao.php";
$codigo = $_POST["codigo"];
$sql = "SELECT * FROM Produto WHERE codproduto = $codigo";
...
else
{
 ...
 $p = $linha["preco"];
?>
<form method="POST" action="alterarProduto3.php">
Nome do produto: <br />
<input type="text" size="50" name="nome" value="<?php echo $n; ?>" /><br /><br />
Quantidade: <br />
<input type="text" size="10" name="qtd" value="<?php echo $q; ?>" /><br /><br />
Preço: <br />
<input type="text" size="10" name="preco" value="<?php echo $p; ?>" /><br /><br />
...
?>
<br /><br /><a href="alterarProduto1.php">Voltar</a>
</secton>
</BODY>
</HTML>